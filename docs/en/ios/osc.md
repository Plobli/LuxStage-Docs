...
A dropdown in the top left shows the currently active **venue**. Tapping it opens the list of all configured EOS addresses (e.g. "Venue", "Venue 2", "venue-1") — the active venue is marked with a checkmark. Venues are managed in [Settings](./einstellungen).

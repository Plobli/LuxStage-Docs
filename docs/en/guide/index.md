...
LuxStage is the professional app for lighting documentation in theatre and events — as a native iOS app and as a web app.

## Two apps. One system.

Whether at the mixing desk or on stage – LuxStage is exactly where you are.

### LuxStage for iOS

The native SwiftUI app for iPhone and iPad. Fast, responsive and optimised for touch — whether at the mixing desk or on stage.

- Optimised for iPhone & iPad
- Native SwiftUI – no browser required
